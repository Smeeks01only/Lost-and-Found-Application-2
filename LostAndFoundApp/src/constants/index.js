...
export const STATUS_LABELS = {
  ...
  SEARCHING: {
    label: "Searching",
    color: "#3B82F6",
    fadedBg: "rgba(59, 130, 246, 0.15)",
  },
  MATCHED: {
    label: "Matched",
    color: "#10B981",
    fadedBg: "rgba(16, 185, 129, 0.15)",
  },
  CLAIMED: {
    label: "Claimed",
    color: "#8B5CF6",
    fadedBg: "rgba(139, 92, 246, 0.15)",
  },
  EXPIRED: {
    label: "Expired",
    color: "#6B7280",
    fadedBg: "rgba(107, 114, 128, 0.15)",
  },
...
export const getStatusInfo = (status) =>
  STATUS_LABELS[status] || DEFAULT_STATUS;
